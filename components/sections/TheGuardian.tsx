            ...
            <div className="max-w-4xl mx-auto relative z-10 text-center">
                ...
                >
                    ...
                    <div className="space-y-6">
                        ...
                        <h2 className="text-5xl md:text-7xl font-accent text-black uppercase tracking-tighter leading-[0.9]">
                    ...
                    <div className="space-y-12 max-w-2xl mx-auto">
                        <div className="space-y-8 text-[#1a1a1a]/80 font-serif text-lg leading-relaxed md:text-xl">
                            <p className="font-display italic text-black text-3xl md:text-4xl leading-tight">
                        ...
                        <div className="pt-12 border-t border-black/5">
                            ...
                            >
                                ...
                                <div className="relative">
                                    <span className="text-3xl md:text-4xl font-accent text-black uppercase tracking-wider group-hover:text-[#D4AF37] transition-all duration-700 group-hover:drop-shadow-[0_0_20px_rgba(212,175,55,0.4)]">
                                        Michael Jara
                                    </span>
                                    <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-0 h-px bg-[#D4AF37] group-hover:w-full transition-all duration-700"></div>
                                </div>
                                <div className="mt-4 flex flex-col items-center gap-2">
                                    <span className="text-[10px] font-display italic text-[#1a1a1a]/40 opacity-0 group-hover:opacity-100 transition-opacity duration-700">
